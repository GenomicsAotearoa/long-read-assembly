...
<center>![image](../theme_figures/scaling.png){width="300"}</center>
...
!!! info ""
    ...
    === "Overview of HPC Architecture"
        ...
        <br>
        ![image](../theme_figures/hpc_arch_new_fixalignment.png){width="700"}
        <br>

    === "Composition of a node"

        <br><center>
        ![image](../theme_figures/node_overview.png){width="500"}
        </center><br>

    === "In reality"

        <center>
        ![image](../theme_figures/mahuika_maui_real.png){width="700"}
        </center>
...
!!! info "The Linux operating system is made up of three parts; the ^^kernel^^, the ^^shell^^ and the software"
    ...
    <center>
    ![image](../theme_figures/interpreter_loop.png){width="200"}
    </center>
...
<center>![image](../theme_figures/scheduler_image.png){width="500"}</center>
...
!!! info "Why do we need a scheduler ?"
    ...
    * LSF – IBM Systems
    ...
    <center>![image](../theme_figures/slurm_comms2compute.png){width="800"}</center>
...
<br>
<center>![image](../theme_figures/batch_system_flow.png){width="800"}</center>
<br>
...
<br>
![image](../theme_figures/anatomy_of_a_slurm_script.png){width="700"}
<br>
...
!!! bell "Assigning values to Slurm variables"
    ...
    <center>![image](../theme_figures/sbtach_def_1.png)</center>

    <center>![image](../theme_figures/sbatch_def_2.png)</center>
...
??? question "Exercise"
    ...
    * There is a `Slurm_Intro` directory which has the following directory structure 
    ...
    <center>![image](../theme_figures/slurm_intro_struc.png){width="500"}</center>

    * We will work from **1.** to **4.** . Objective is to review, submit, check and *review* Slurm jobs. 

    <center>![image](../theme_figures/slurm_cycle_mini.png)</center>